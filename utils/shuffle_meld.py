...
def sample_df(df, num_samples):
    for label in label_conveter.keys():
        df_sampled = df[df.label == label]
        df_sampled = df_sampled.sample(n=num_samples//7, replace=True)
...
def sample_data_set(meta_csv_file, num_train_samples, num_test_samples, num_dev_samples):
    ...
    dst_path = "C:/Users/Ella bar-El/Documents/Deep_Learning/SpeechFormerProject/MELD.Raw/train/wav_for_cloud/"
    os.mkdir(dst_path) 
    ...
    dst_path = "C:/Users/Ella bar-El/Documents/Deep_Learning/SpeechFormerProject/MELD.Raw/test/wav_for_cloud/"
    os.mkdir(dst_path)
    ...
    dst_path = "C:/Users/Ella bar-El/Documents/Deep_Learning/SpeechFormerProject/MELD.Raw/dev/wav_for_cloud/"
    os.mkdir(dst_path)
    ...
    output_df.to_csv("C:/Users/Ella bar-El/Documents/Deep_Learning/SpeechFormerProject/S4SpeechFormer/metadata/metadata_meld_for_cloud.csv")
